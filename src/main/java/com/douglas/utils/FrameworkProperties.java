	...
	public static String getProperty(String key, String defaultValue) {
        ...
        if (null == prop) {
            ...
            try {
                ...
                is = (FrameworkProperties.class.getClassLoader().getResource("framework.properties") != null) ? FrameworkProperties.class
                        .getClassLoader().getResource("framework.properties").openStream()
                        : null;
